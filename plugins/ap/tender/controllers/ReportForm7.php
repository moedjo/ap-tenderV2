...
class ReportForm7 extends Controller
{
    public $implement = [
    ...
    {
        parent::__construct();
        BackendMenu::setContext('Ap.Tender', 'reporting', 'report-form7');
    }
    ...
    public function print($model)
    {
        ...
        return PDF::loadTemplate('ap.tender::pdf.report-form7', $data)->stream();
    }
    ...
    protected function savePdf($model)
    {
        ...
        $pdf_file_name =  $name = strtolower(trim(preg_replace('/[^A-Za-z0-9-]+/', '_', "BERITA ACARA HASIL PENILAIAN ENVELOPE II"))) . '_' . date('H') . '.pdf';
        $pdf_file_name_directory =  $storagePath . $pdf_file_name;

        PDF::loadTemplate('ap.tender::pdf.report-form7', $data)->save($pdf_file_name_directory);
